...
for ind, file in enumerate(filelist):
        ...
        for ind, file in enumerate(patent_filelist):
            if ind ==0:
                    print('Second patent file is:', file)
                    ...
                    stemmed_tokens2 = [stemmer2.stem(word=word) for word in tokens2]  # list of stemmed tokens
                    print(stemmed_tokens2)
                    print(' '.join(stemmed_tokens2))
                    vector_abstract2 = text_to_vector(' '.join(stemmed_tokens2))
                    print('I am the second abstract vector:', vector_abstract2)
